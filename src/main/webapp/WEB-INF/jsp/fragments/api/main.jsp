...
<div id="apiPage" class="page-root" data-page-url="/api/main.do">
    ...
    <div class="toolbar btns no-wrap" role="toolbar" aria-label="api actions">
        ...
        <input type="text" class="input" id="api_search_keyword" style="width:180px; min-width:180px;" placeholder="caller, target" />
            ...
            <div class="grid-scroll" id="apiListWrap">
                <table class="tbl" id="apiTable">
                    ...
                    <tr>
                        ...
                        <th style="width:90px;" data-align="center">Method</th>
                        <th style="width:320px;" data-align="left">API Pattern</th>
...
<script src="${pageContext.request.contextPath}/static/js/api/api.js?v=20260326_01"></script>
